...
class DeleteRating003Test extends DuskTestCase
{
    /**
     * A Dusk test example.
     * * @group DeleteRating003
     */
    public function testDeleteRating003(): void
    {
        $this->browse(function (Browser $browser) {
            $browser->visit('/login')
                ...
                ->click('.btn.btn-secondary') // Klik tombol Batal di dalam modal
